...
groupmeAPI = "https://api.groupme.com/v3/groups/" + config.groupid + "/messages?token=" + config.token + "&limit=100"
group_data = "https://api.groupme.com/v3/groups/" + config.groupid + "?token=" + config.token
